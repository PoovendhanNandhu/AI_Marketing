...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex min-h-[85vh] w-full items-center justify-center bg-white dark:bg-black",
        containerClassName,
      )}
    ...
    >
      ...
      <div className={cn("relative z-20 px-4", className)}>{children}</div>
    </div>
  );
};
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 px-1 pb-1 dark:from-indigo-500 dark:to-purple-500`,
        className,
      )}
    >
      {children}

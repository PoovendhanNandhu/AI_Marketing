              ...
              <Link href={story.caseStudyHref} key={index} legacyBehavior>
                ...
                >
                  <div className="p-5 md:p-6 flex flex-col justify-between h-full">
                    <div>
                      {story.metric && (
                        <div className={`text-4xl md:text-5xl font-bold ${story.textColor} mb-2`}>
                          {story.metric}
                        </div>
                      )}
                      {story.description && (
                        <p className={`text-base md:text-lg ${story.textColor} mb-4`}>
                          {story.description}
                        </p>
                      )}
                      {story.quote && (
                        <blockquote className={`text-base md:text-lg italic ${story.textColor} mb-4 border-l-4 pl-4 ${story.textColor?.replace('text-', 'border-')} border-opacity-50`}>
                           {story.quote}
                        </blockquote>
                      )}
                       {story.personImageSrc && (
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          />
                          <div>
                            <p className={`font-semibold text-sm ${story.textColor}`}>{story.personName}</p>
                            <p className={`text-xs ${story.textColor} opacity-80`}>{story.personTitle}</p>
                          </div>
                        </div>
                       )}
                    </div>
                    <div className="mt-auto flex justify-between items-center pt-4">
                      ...
                      />
                      <ArrowRight className={`w-6 h-6 ${story.textColor} opacity-70 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300`} />
                    </div>
                  </div>
                </a>
              </Link>
